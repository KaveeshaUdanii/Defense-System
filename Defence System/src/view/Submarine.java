...
public class Submarine extends javax.swing.JFrame {
    ...
    public Submarine() {
        initComponents();
        setButtonsEnabled(false); //for disable all buttons
        jCheckBox1.addActionListener(e -> updateButtonStates(-1));// Update button states when checkbox is toggled
    }
    ...
    private void initComponents() {
        ...
        jButton2.setText("Sonar Operations");
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        mainController.updateTextArea(text, "Submarine");
